...
<form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="bg-white shadow-sm rounded-lg p-8">
                    <div class="space-y-6">
                        ...
                        <div>
                            <x-input-label for="identitas" :value="'Identitas (KTP/NIM)'" />
                        ...
                        <div>
                            ...
                            <x-text-input id="nohp" name="nohp" type="text" class="mt-1 block w-full" :value="old('nohp')" />
                        ...
                        <div>
                            ...
                            <select id="role" name="role" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                                ...
                                <option value="admin" {{ old('role') == 'petugas' ? 'selected' : '' }}>Petugas</option>
                        ...
                        <div>
                            ...
                            <x-input-label for="password_confirmation" :value="'Konfirmasi Password'" class="mt-4" />
